...
inputs = torch.tensor([ 
    #ROW 0
          [6.4,1862,1545,1223,1765,0],
          [7.44,2206,1711,1737,1786,0],
          [31.4,8138,7487,5614,10118,0],
          #[13.6],
    #ROW 1
          #[14.5],
          #[13.4],
          #[7.8],
          [8.33,2143,2025,2395,1769,0],
    #ROW 2
          #[8.42],
          [8.5,1976,1562,2986,1983,0],
          [9.18,3411,2373,1772,2163,0],
          [5.39,1291,1254,1157,1694,0],
    #ROW 3
          [6.41,1576,1314,1296,2221,0],
          [48.5,12334,12820,11362,11986,0],
          [152.0,24248,52422,51308,24033,0],
          #[169.0]
    ...
    #ROW 4
          #[4.22],
          [7.13,2314,1476,1450,1972,0],
          #[9.49],
          [9.65,1889,2724,2893,2140,0],
    #ROW 5
          [11.2,3467,2431,2227,3036,0],
          [15.9,4634,3732,3802,3726,0],
          [2.02,894,625,675,827,0],
          [13.2,4371,2656,2448,3745,0],
    #ROW 6
          [9.4,2230,2704,2378,2080,0],
          [235,50536,68279,67176,49655,0],

    #BONUS DATA 2, ELECTRIC FUNGALBOO

    #ROW 7
        [14274.48,4751512,2387147,2388460,4747361,1],
        [39686.25,9485087,10338110,10349945,9505768,1],
        [39112.55,9340513,10199767,10212192,9358737,1],
        [18916.11,4897552,4558519,4560957,4898624,1],
    #ROW 8    
        [12071.33,3730180,2309287,2313713,3718146,1],
...
for x in range(len(inputs)):
    ...
    for y in range(1,len(inputs[x])):
        ...
        bu = inputs[x][y]
        #inputs[x][y]=math.log(inputs[x][y])**2/10000
        #inputs[x][y]=1-math.sqrt((1/math.e)**math.log10(1+(bu*(1/math.e))))
        inputs[x][y]=math.sqrt(math.cbrt(math.tanh(((bu)/math.sqrt(total))/100000)))*15
...
default_dir = "mutAI/dataOutputFiles/DataSet1&3_Seq/TEST_outData_mut_size_DataSet1&3_Seq.txt"
...
def visuals(targ,guess,gsize,targ2,guess2,gsize2):
    ...
    plt.savefig('mutAI/dataVisuals/DataSet1&3_Seq/TEST_plot_mut_Size_ln.png')
