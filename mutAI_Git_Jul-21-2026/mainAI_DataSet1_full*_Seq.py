...
print("How many training scycles do you want? (Type zero for default of 5000)")
loops = int(input())
...
default_dir = "mutAI/dataOutputFiles/DataSet1_Seq/outData_mut_size_DataSet1_Seq.txt"
