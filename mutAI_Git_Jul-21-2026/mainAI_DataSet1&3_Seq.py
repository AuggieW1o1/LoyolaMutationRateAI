...
inputs = torch.tensor([ 
    ...
    [29257.63,7393205,7242100,7226885,7395442],
    [39686.25,9485087,10338110,10349945,9505768],
    [41953.16,10073894,10901351,10906094,10071818],
    
    [39328.96,9502697,10164899,10185765,9475597],
...
for x in range(len(inputs)):
    ...
    for y in range(1,len(inputs[x])):
        ...
        inputs[x][y]=math.log(inputs[x][y]/total)
time.sleep(1)
ready=1
time.sleep(0.4)
...
default_dir = "mutAI/dataOutputFiles/DataSet1&3_Seq/outData_mut_size_DataSet1&3_Seq.txt"
...
def visuals(targ,guess,gsize,targ2,guess2,gsize2):
    ...
    plt.savefig('mutAI/dataVisuals/DataSet1&3_Seq/plot_mut_Size_ln.png')
